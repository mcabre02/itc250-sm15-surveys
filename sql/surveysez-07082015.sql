...
/*
the first 2 answers map to q1
the next 3 answers map to q2
the last 3 map to q3
*/
...
INSERT INTO sm15_answers VALUES (NULL,3,'Peanut','',NOW(),NOW());
